...
export default function Nav(props) {
  ...
  return createPortal(
    <div
      className={
        "navbar bg-base-100 rounded-2xl px-4 shadow-inner drop-shadow-xl mb-6 bg" +
        props.className
      }
    >
      {/* burger */}
      ...
      <div className="flex-1">
        <a className="btn btn-ghost normal-case text-xl">Wallpaper Manager</a>
      </div>

      {/* tabs */}
      <div className="w-full ">
        <div className="tabs tabs-boxed mx-auto shadow-inner drop-shadow-sm ">
          {data.map((a) => {
            return (
              <button
                key={a.value}
